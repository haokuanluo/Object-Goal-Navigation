...
ADD objnav.sh objnav.sh
ADD objnav_pretrained_models objnav_pretrained_models
ENV AGENT_EVALUATION_TYPE remote
ENV PYTHONPATH "${PYTHONPATH}:./Object-Goal-Navigation"


CMD ["/bin/bash", "-c", "export PYTHONPATH=/evalai-remote-evaluation:$PYTHONPATH && export CHALLENGE_CONFIG_FILE=$TRACK_CONFIG_FILE && bash objnav.sh"]
