...
def get_args():
    ...
    parser.add_argument('--save_interval', type=int, default=1,
                        help="""save interval""")
    parser.add_argument('-d', '--dump_location', type=str, default="./habitat-challenge-data/tmp3/",
    ...
    parser.add_argument("--task_config", type=str,
                        default="challenge_objectnav2020.local.rgbd.yaml",
    ...
    parser.add_argument('--use_gt_location', type=int, default=1,
                        help='use ground truth location')

    parser.add_argument('--allow_sliding', type = int, default=1,
                        help='allow agent sliding')

    parser.add_argument('--task', type = str, default = 'objectgoal',
                        help = 'task type')
    ...
    parser.add_argument('--block_threshold', type=float, default=1.0)

    parser.add_argument('--semantic_chanel',type=int,default = 15) #also need to fix semantic util two place 58 and 25
    ...
    if args.cuda:
        if args.auto_gpu_config:
            ...
            num_processes_on_first_gpu = int((gpu_memory - 7.0)/1.4)
            ...
            if num_gpus == 1:
                ...
                print("hea",args.num_processes,num_processes_on_first_gpu)
            else:
