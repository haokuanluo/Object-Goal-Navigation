...
from agents.utils.statistics import Stat_Tool
...
class ObjectGoal_Env(habitat.RLEnv):
    ...
    def __init__(self, args, rank, config_env, dataset):
        ...
        #statistics
        self.statistics_tool = Stat_Tool(6)
    ...
    def load_new_episode(self):
        ...
        self.statistics_tool.update_scene(scene_name)
    ...
    def reset(self):
        ...
        """
        args = self.args
        new_scene = self.episode_no % args.num_train_episodes == 0 if self.split != "val" else (self.episode_no) % args.num_eval_episodes == 0
    ...
    def step(self, action):
        ...
        if done:
            ...
            self.statistics_tool.update(gid,success == 1,item_found)
            self.statistics_tool.show_stats()
