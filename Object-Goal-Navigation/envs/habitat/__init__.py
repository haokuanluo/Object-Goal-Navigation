...
def construct_envs(args):
    ...
    basic_config = cfg_env(config_paths=["Object-Goal-Navigation/envs/habitat/configs/"
                                         + args.task_config])
    ...
    for i in range(args.num_processes):
        config_env = cfg_env(config_paths=["Object-Goal-Navigation/envs/habitat/configs/"
                                           + args.task_config])
        config_env.defrost()
